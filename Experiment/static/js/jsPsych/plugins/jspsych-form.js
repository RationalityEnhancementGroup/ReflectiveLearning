...
var schema = {
  ...
  jsPsych.plugins["form"] = (function() {
    ...
    function end_trial() {
      ...
      for (var i = 0; i < questions.length; i++) {
        ...
        var key = question.name || question.question || question.label || question.type;
  ...
  */
  function Form(display_element, item) {
    ...
    this.form_title_html = '<label style="font-size: {0};padding-bottom: 30px; font-weight: bolder;" class="mdl-layout-title mdl-color-text--{1}">{2}<br>{3}</label><br><br>'.format(
    ...
    <div class="mdl-grid" style="max-width: 1600px;width: calc(100% - 16px);margin: 0 auto;margin-top: 10vh;">\
    <div class="mdl-cell mdl-cell--2-col mdl-cell--hide-tablet mdl-cell--hide-phone"></div>\
    <div class="mdl-color--{0} mdl-shadow--{4}dp mdl-cell mdl-cell--8-col" style="border-radius: 2px;padding: 40px 40px;margin-bottom: 80px;margin-top: -60px;">\
    <div class="mdl-color-text--{1}" id="{2}" style="width: 100%;">{3}</div></div>\
    <div class="mdl-layout mdl-color-text--grey-600" style="text-align: center; font-size: 12px; margin-top: -60px">\
    </div><div class="mdl-layout mdl-color-text--grey-700" style="text-align: center; font-size: 19px; margin-top: -30px">\
    </div></div></main>'.format(
  ...
  */
  function Tag(parent_id, item) {
    ...
    if (this.question_description)
      this.question_description_html = '<p style="font-size: {0};padding-top: 0px;" class="mdl-layout-title mdl-color-text--{1}">{2}</p>'.format(
  ...
  */
  function Range(parent_id, item) {
    ...
    this.value_prompt = item.valube_prompt || "value: ";
    if (!this.needQuestion && this.star != "")
...
Dropdown.prototype._option_factory = function() {
  ...
  */
  ...
  function Checkbox(parent_id, item) {
    ...
    // item.label = "Checkbox #{0}".format(__INPUT_CHECKBOX - 1);
  ...
  function Radio(parent_id, item) {
    ...
    item.labels = item.labels || "Radio #{0}".format(__INPUT_RADIO - 1);
    Toggle.call(this, parent_id, item);
